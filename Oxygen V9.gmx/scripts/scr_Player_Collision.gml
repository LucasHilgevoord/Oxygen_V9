...
if (place_meeting(x+hspd, y, obj_Door_Hitbox)) {
...
if (place_meeting(x, y+vspd, obj_Door_Hitbox)) {
    while (!place_meeting(x, y+sign(vspd), obj_Door_Hitbox)) {
        y+= sign(vspd);
        }
        vspd = 0;
}
